...
class TestTriangle(unittest.TestCase):
    ...
    def test_make4(self):
        ...
        for triangle, expected in cases:
            with self.subTest(triangle=triangle):
                self.assertEqual(triangle.make4(), expected, msg=f"Failure during make4 method test"
                                                                 f"expected {expected} get {triangle.make4()} instead.")
